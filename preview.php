                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row text-center">
                                                        ...
                                                        <div class="row d-flex justify-content-center">
                                                            <div class="col-sm-6 col-12">
                                                                <p><strong>Address:</strong> <?= $customer['street'] . " " . $customer['area']. " " . $customer['city']. " " . $customer['district']. " " . $customer['state']. " " . $customer['country']. " " . $customer['pincode']; ?></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="text-center">
                                                        <a href="mailto:<?= $customer['email'] ?>" class="btn btn-outline-primary btn-sm">Send Email</a>
                                                        <a href="tel:<?= $customer['mobile_number'] ?>" class="btn btn-primary btn-sm">Call Now</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
