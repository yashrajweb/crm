                                ...
                                <div class="table-rep-plugin">
                                    <div class="table-responsive mb-0" data-pattern="priority-columns">
                                        ...
                                        if (isset($_GET['id'])) {
                                            ...
                                            $query1 = "SELECT * FROM quotation_sales WHERE id='$customer_id'";
                                            ...
                                            $id = $quotation['register_customer_id'];
                                            $query = "SELECT * FROM register_customer WHERE register_customer_id='$id'";
