                                            ...
                                            <table id="datatable-buttons" class="table table-bordered table-table-responsive nowrap w-100">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Mobile 1</th>
                                                        <th>Apps</th>
                                                        <!-- <th>Domain Related</th> -->
                                                        <th>Actions</th>
                                                    </tr>
                                                </thead
                                                    <tbody>
                                                <?php
                                                $query = "SELECT * FROM register_customer WHERE markasdelete = 'No'";
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>
                                                                <div style="display: flex; flex-direction: column; gap: 9px; align-items: flex-start;">
                                                                    <!-- Invoice and Dropdown -->
                                                                    <div style="display: flex; gap: 10px; align-items: center;">
                                                                        <a href="enquiry.php?id=<?= $customer['register_customer_id']; ?>" title="Enquiry" class="btn btn-primary">
                                                                        ...
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <ul class="dropdown-menu">
                                                                                <li><a class="dropdown-item" href="new-select.php?id=<?= $customer['register_customer_id']; ?>&type=website" title="Quotation">Website</a></li>
                                                                                <li><a class="dropdown-item" href="new-select.php?id=<?= $customer['register_customer_id']; ?>&type=sales" title="Quotation">Sales</a></li>
                                                                                <li><a class="dropdown-item" href="new-select.php?id=<?= $customer['register_customer_id']; ?>&type=repair" title="Quotation">Repair</a></li>
                                                                            </ul>
                                                                        </div>
                                                                        ...
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <ul class="dropdown-menu">
                                                                                <li><a class="dropdown-item" href="new-invoice.php?id=<?= $customer['register_customer_id']; ?>&type=website" title="Quotation">Website</a></li>
                                                                                <li><a class="dropdown-item" href="new-invoice.php?id=<?= $customer['register_customer_id']; ?>&type=sales" title="Quotation">Sales</a></li>
                                                                                <li><a class="dropdown-item" href="new-invoice.php?id=<?= $customer['register_customer_id']; ?>&type=repair" title="Quotation">Repair</a></li>
                                                                            </ul>
                                                                        </div>
                                                                    ...
                                                                    <div style="display: flex; gap: 12px; align-items: center;">
                                                                        <a href="domain.php?id=<?= $customer['register_customer_id']; ?>&type=domain" title="Domain" class="btn btn-success">
                                                                            <i class="fa-solid fa-d"></i>
                                                                        </a>
                                                                        <a href="domain.php?id=<?= $customer['register_customer_id']; ?>&type=hosting" title="Hosting" class="btn btn-success">
                                                                            <i class="fa-solid fa-h"></i>
                                                                        </a>
                                                                        <a href="domain.php?id=<?= $customer['register_customer_id']; ?>&type=ssl" title="SSL" class="btn btn-success">
                                                                            <i class="fa-solid fa-s"></i>
                                                                        </a>
                                                                        
                                                                    </div>
                                                                    <div style="display: flex; gap: 8px; align-items: center;">
                                                                        <!-- <a href="domain.php?id=<?= $customer['register_customer_id']; ?>" title="Domain" class="btn btn-warning">
                                                                            <i class="fa-solid fa-book"></i>
                                                                        </a> -->
                                                                        <a href="email.php?id=<?= $customer['register_customer_id']; ?>" title="Email" class="btn btn-warning">
                                                                            <i class="fa-solid fa-envelope"></i>
                                                                        </a>
                                                                        <a href="renewal.php?id=<?= $customer['register_customer_id']; ?>" title="Renewal" class="btn btn-warning">
                                                            ...
                                                            <th>
                                                                <div style="display: flex; gap:8px; align-items: center;">
                                                                    <a href="preview.php?id=<?= $customer['register_customer_id']; ?>" title="View" class="btn btn-primary">
                                                                        <i class="fa-regular fa-eye"></i>
                                                                    </a>
                                                                    <a href="edit.php?id=<?= $customer['register_customer_id']; ?>" title="View" class="btn btn-warning">
                                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                                    </a>
                                                                    <a href="customer-register_code.php?id=<?= $customer['register_customer_id']; ?>" title="View" class="btn btn-danger">
