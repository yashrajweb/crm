                                ...
                                <div class="table-rep-plugin">
                                    <div class="table-responsive mb-0" data-pattern="priority-columns">
                                        ...
                                        if (isset($_GET['id'])) {
                                            ...
                                            $query1 = "SELECT * FROM quotation_repair WHERE id='$quotation_id'";
                                            $query_run1 = mysqli_query($con, $query1);

                                            if (mysqli_num_rows($query_run1) > 0) {
                                                $quotation = mysqli_fetch_assoc($query_run1);
                                            } else {
                                                echo "<h5 class='text-center text-danger'>No records found</h5>";
                                                exit;
                                            }

                                            $query = "SELECT * FROM register_customer WHERE register_customer_id='{$quotation['register_customer_id']}'";
                                            ...
                                            <div class="card shadow-lg border-0 rounded-4 w-100">
                                                ...
                                                <div class="card-body d-flex flex-column align-items-center">
                                                    ...
                                                    <div class="row text-start w-100">
                                                        ...
                                                        <hr>
                                                        <h4 class="card-title text-center text-primary mb-3">Quotation: <?= $quotation['title'] ?></h4>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6 col-12">
                                                                <p style="display: inline;"><?= $quotation['description'] ?></p>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6 col-12">
                                                                <p><strong>Model:</strong> <?= $quotation['model'] ?></p>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-6 col-12">
                                                                <p><strong>MRP:</strong> <?= $quotation['mrp'] ?></p>
                                                            </div>
                                                            <div class="col-sm-6 col-12">
                                                                <p><strong>Offer Price:</strong> <?= $quotation['offerprice'] ?></p>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-4 col-sm-6 col-12">
                                                                <img src="<?= $quotation['image1'] ?>" alt="repair-image 1" class="img-fluid">
                                                            </div>
                                                            <div class="col-lg-4 col-sm-6 col-12">
                                                                <img src="<?= $quotation['image2'] ?>" alt="repair-image 2" class="img-fluid">
                                                            </div>
                                                            <div class="col-lg-4 col-sm-6 col-12">
                                                                <img src="<?= $quotation['image3'] ?>" alt="repair-image 3" class="img-fluid">
                                                            </div>
                                                            

                                                        </div>

                                                        <h4 class="card-title text-end text-warning mb-3">Quotation Date: <?= $quotation['datetime'] ?></h4>
