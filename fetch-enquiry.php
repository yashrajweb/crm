                                    ...
                                    <div class="table-rep-plugin">
                                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                                            <table id="datatable-buttons" class="table table-bordered table-table-responsive nowrap w-100">
                                                ...
                                                $query = "SELECT * FROM enquiry WHERE status = 'Pending'";
                                                $query_run = mysqli_query($con, $query);

                                                if (mysqli_num_rows($query_run) > 0) {
                                                    foreach ($query_run as $enquiry_details) {
                                                        $customer_id = $enquiry_details['register_customer_id'];
                                                ...
                                                ?>
                                                        ...
                                                        <tr>
                                                            <!-- <input type="text" name="" id="" value="<?= $enquiry_details['enquiry_id'] ?>"> -->
                                                            <th><?= $customer['register_customer_id'] ?></th>
                                                            <th><?= $customer['first_name'] ?> <?= $customer['last_name'] ?></th>
                                                            <th><?= $customer['mobile_number'] ?></th>
                                                            <th><?= $customer['email'] ?></th>
                                                            <th><?= $enquiry_details['enquiry_title'] ?></th>
                                                            <th><?= $enquiry_details['description'] ?></th>
                                                            <th><?= $enquiry_details['dateOfEnquiry'] ?></th>
                                                            <th><?= $enquiry_details['reminder_date'] ?></th>
                                                            <th>
                                                            <a href="enquiry_code.php?id=<?= $enquiry_details['enquiry_id'] ?>" title="View" class="btn btn-success">
                                                                        <i class="fa-solid fa-check"></i> lorem
                                                                    </a>
                                                            </th>
                                                            ...
                                                            <!-- <th> -->
                                                                <!-- <div style="display: flex; gap:8px; align-items: center;">
                                                                    ...
                                                                    <a href="customer-register_code.php?id=<?= $customer['register_customer_id']; ?>" title="View" class="btn btn-warning">
