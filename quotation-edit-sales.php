        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    if (isset($_GET['qid'])) {
                        $quotation_id = mysqli_real_escape_string($con, $_GET['qid']);
                        $register_customer_id = mysqli_real_escape_string($con, $_GET['customer_id']);
                        // $title = mysqli_real_escape_string($con, $_POST['title']);
                        $query = "SELECT * FROM quotation_sales WHERE id='$quotation_id'";
                        $query_run = mysqli_query($con, $query);

                        if (mysqli_num_rows($query_run) > 0) {
                            $quotation = mysqli_fetch_assoc($query_run);
                            // $query_title = "SELECT * FROM quotation_sales_master WHERE title = '$title'";
                            // // $query_title_run = mysqli_query($con, $query_title);
                            // if (mysqli_num_rows($query_title_run) > 0) {
                            //     $master = mysqli_fetch_assoc($query_title_run);
                            // } else {
                            //     
                            //     exit;
                            // }
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="fetch-customer.php">Customer Details</a>
                                        </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <form action="quotation-edit-code.php" method="post" class="needs-validation" novalidate>
                                <!-- honorific -->
                                <input type="hidden" name="register_customer_id" value="<?= $register_customer_id; ?>">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" readonly class="form-control"
                                                value="<?= $quotation['title'] ?>" id="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="company" class="form-control" id="company"
                                                placeholder="Company" value="<?= $quotation['company'] ?>"></input>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="model" value="<?= $quotation['model'] ?>" class="form-control" id="model"
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="serial_number" value="<?= $quotation['serial_number'] ?>" class="form-control"
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="mrp" value="<?= $quotation['mrp'] ?>" id="mrp" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-12">
                                        <div class="mb-3">
                                            <label class="form-label" for="mrp">Offer Price</label>
                                            <input type="number" name="offerprice" value="<?= $quotation['offerprice'] ?>" id="offer" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <button class="btn btn-primary" name="edit-sales"  type="submit">Save Changes</button>
