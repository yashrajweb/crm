...
<body>
    ...
    <div class="customer">
        ...
        if (isset($_GET['id'])) {
            ...
            $query_invoice = "SELECT * FROM invoice_web WHERE invoice_id  = '$invoice_id'";
        ...
        ?>
            <table>
                <tr>
                    ...
                    <td><?= $invoice_details['gene_date'] ?></td>
                </tr>
                <tr>
    ...
    <div class="description">
        ...
        <table>
            ...
            <tr>
                ...
                <td><b><?= $invoice_details['domain_name'] ?></b></td>
                <td class="header">Register Date: </td>
                <td><b><?= $invoice_details['domain_reg_date'] ?></b></td>
                <td class="header">Expiry Date: </td>
                <td><b><?= $invoice_details['domain_exp_date'] ?></b></td>
            </tr>
        </table>
    </div>
