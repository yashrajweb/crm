...
if(isset($_POST['package-btn'])){
    ...
    $_SESSION['title'] = mysqli_real_escape_string($con,$_POST['title']);   
}
?>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Quotation Repair</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <form action="quotationGenerationRepair.php" method="post" class="needs-validation" novalidate enctype="multipart/form-data">
                                ...
                                <?php
                                $query = "SELECT * FROM quotation_repair_master where title ='{$_SESSION['title']}'";
    ...
    <!-- <script>
        function toggleCamera() {
            ...
            camera.style.display = camera.style.display === 'none' ? 'block' : 'none';
