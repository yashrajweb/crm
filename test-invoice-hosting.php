...
<body>
    ...
    <div class="customer">
        <?php
        if (isset($_GET['id'])) {
            $hosting_id = mysqli_real_escape_string($con, $_GET['id']);

            $query_quotation = "SELECT * FROM hosting WHERE id  = '$hosting_id'";
    ...
    <div class="description">
        ...
        <table>
            ...
            <tr>
                <td colspan="4">
                    <p><strong>Domain Name :</strong><?=$domain_details['domain']?></p>
