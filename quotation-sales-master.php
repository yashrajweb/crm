            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Sales Master</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Primary Services</a></li>
                                        <li class="breadcrumb-item active">Sales Master</li>
                                    </ol>
                                </div>
                    ...
                    <div class="row">
                        ...
                        ?>
                        <div class="col-lg-12">
                            <form action="quotation-sales-master-code.php" method="post" class="needs-validation" novalidate>
                                <!-- honorific -->
                                <div class="row">
                                    <div class="col-6">
                                        <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="company" class="form-control" id="company" placeholder="Company" required></input>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                            <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="model" class="form-control" id="model" placeholder="Model" required></input>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                            <div class="invalid-feedback">
