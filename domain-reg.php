                                        ...
                                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                                            <table id="datatable-buttons"
                                                ...
                                                if (mysqli_num_rows($query_run) > 0) {
                                                    foreach ($query_run as $email) {
                                                        $customer_id = $email['register_customer_id'];
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th><?= $email['title'] ?></th>
                                                            <th><?= $email['domainName'] ?></th>
                                                            <th><?= $email['service_provider'] ?></th>
                                                            <th><?= $email['reg_date'] ?></th>
                                                            <th><?= $email['exp_date'] ?></th>


                                                            <th>
                                                                <div style="display: flex; gap:8px; align-items: center;">
                                                                    <a href="preview-domain-details.php?id=<?= $customer['register_customer_id']; ?>&preview_id=<?= $email['id'] ?>"
