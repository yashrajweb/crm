                        ...
                        <div class="col-12">
                            ...
                            <div class="row">
                                                            ...
                                                            <table id="datatable-buttons" class="table table-bordered table-table-responsive nowrap w-100">
                                                                ...
                                                                ?>
                                                                        <tr>
                                                                            ...
                                                                            <th>
                                                                                <a href="preview-sales-quotation.php?id=<?= $customer['register_customer_id']; ?>" title="view" class="btn btn-primary"><i class="fa-regular fa-eye"></i></a>
                                ...
                                <div style="width: 100%;" class="d-flex justify-content-center align-items-center">
                                    <form action="quotation-sales.php" method="post" class="p-4 border rounded shadow">
