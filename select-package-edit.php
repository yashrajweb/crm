...
?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Select Package</h4>
                        ...
                        <div style="width: 100%;" class="d-flex justify-content-center align-items-center">
                                        <form action="quotation-edit-website.php" method="post" class="p-4 border rounded shadow">
                                            <input type="text" name="quotation_id" value="<?= $quotation_id; ?>">
                                            <input type="text" name="register_customer_id" value="<?= $customer_id; ?>">
