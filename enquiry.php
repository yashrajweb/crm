                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h2 class="mb-sm-0 font-size-18">Enquiry</h2>
                            ...
                            <div class="row mb-5">
                                <div class="row">
                                    <h3 class="text-center text-primary"><b>New Enquiry</b></h3>
                                </div>
                                <div class="col-lg-12">
                                    <form action="enquiry_code.php" method="post" class="needs-validation" novalidate>
                                    <?php
                                        if(isset($_GET['id'])){
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" name="enquiry-title">
                                                        <option>Website Development</option>
                                                        <option>Refurbished laptops</option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" class="form-control" name="remind-Date" id="remindDate">
                                                </div>
                                            </div>
                                            <div class="col-md-2 col-12">
                                                <div class="mb-3">
                                                    <label class="form-label">Reminder Time</label>
                                                    <input type="time" class="form-control" name="remind-Time" id="remindDate">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card mt-5">
                                <div class="card-body">
                                    <div class="row">
                                        <h4 class="mb-3 text-primary">Previous Enquiries</h4>
                                    </div>
                                    <div class="row mb-5" style="max-height: 300px; overflow-y: scroll;">
                                        <div class="col-12">
                                                    ...
                                                    <table id="datatable-buttons" class="table table-bordered table-table-responsive nowrap w-100">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            if (isset($_GET['id'])) {
                                                                ...
                                                                $query_2 = "SELECT * FROM register_customer WHERE register_customer_id = '$customer_id' ";
                                                                $query_run = mysqli_query($con, $query);
                                                                $query_run_2 = mysqli_query($con, $query_2);
                                                                $customer_name = mysqli_fetch_assoc($query_run_2);
                                                                if (mysqli_num_rows($query_run) > 0) {
                                                            ?><h5>Name: <i><?= $customer_name['first_name'] ?> <?= $customer_name['last_name'] ?></i></h5>
                                                                    <?php
                                                                    while ($enquiry = mysqli_fetch_assoc($query_run)) {
                                                                    ?>

                                                                        <tr>
                                                                            <td><?= $enquiry['dateOfEnquiry'] ?></td>
                                                                            <td><?= $enquiry['register_customer_id'] ?></td>
                                                            ...
                                                            <?php
                                                                    ...
                                                                    echo "<tr><td colspan='5' class='text-center'>No enquiries found for this customer.</td></tr>";
                                                                }
                                                            }
                                                            ?>
                                                        </tbody>
