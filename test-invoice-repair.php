...
<body>
    ...
    <div class="customer">
        ...
        if (isset($_GET['id'])) {
            ...
            $query_invoice = "SELECT * FROM invoice_repair WHERE id  = '$invoice_id'";
    ...
    <div class="description">
        ...
        <table>
            ...
            <tr>
                ...
                <td><b><?= $invoice_details['delivery_date'] ?> <?= $invoice_details['delivery_time'] ?></b></td>
            </tr>
        </table>
    </div>
    ...
    <div class="description">
        ...
        <table>
            ...
            <tr>
                ...
                <td class="header">OFFER PRICE:</td>
                <td><b><?= $invoice_details['offerprice'] ?></b> /-</td>
            </tr>
            <tr>
                <td colspan="4" class="terms">Terms and conditions</td>
            </tr>
