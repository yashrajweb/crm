...
<?php
    // Fetch email details
    $query_email = "SELECT * FROM domain WHERE id = '$preview_id'";
    $query_email_run = mysqli_query($con, $query_email);

    if(mysqli_num_rows($query_email_run) > 0) {
        $domain_details = mysqli_fetch_assoc($query_email_run);
    } else {
...
?>
    ...
    <div class="profile-card">
        <div class="btn">
            <a style="background-color: #5a67d8;" class="btn btn-primary" href="domain-reg.php"><i class="fa-solid fa-arrow-right-from-bracket"></i> Back</a>
        </div>
        ...
        <div class="profile-body">
            ...
            <table class="table details-table">
                ...
                <tbody>
                    <tr>
                        <td>Title</td>
                        <td><?=$domain_details['title']?></td>
                    </tr>
                    <tr>
                        <td>Domain Name</td>
                        <td><?=$domain_details['domainName']?></td>
                    </tr>
                    <tr>
                        <td>Service Provider</td>
                        <td><?=$domain_details['service_provider']?></td>
                    </tr>
                    <tr>
                        <td>Register Date</td>
                        <td><?=$domain_details['reg_date']?></td>
                    </tr>
                    <tr>
                        <td>Expiry Date</td>
                        <td><?=$domain_details['exp_date']?></td>
                    </tr>
                    <tr>
                        <td>MRP</td>
                        <td><?=$domain_details['mrp']?></td>
                    </tr>
                    <tr>
                        <td>Offer Price</td>
                        <td><?=$domain_details['offerprice']?></td>
                    </tr>
                    <tr>
                        <td>Activity Status</td>
                        <td><?=$domain_details['status']?></td>
                    </tr>
                </tbody>
            </table>
        </div>
