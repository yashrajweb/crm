            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Edit Web Demo</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="web-demo-master.php">Web Demo</a></li>
                                        <li class="breadcrumb-item active">Edit Web Demo</li>
                                    </ol>
                                </div>
                    ...
                    <div class="row">
                        ...
                        ?>
                        <div class="col-lg-12">
                            <form action="web-demo-master-code.php" method="post" class="needs-validation" novalidate>
                                <?php

                                if(isset($_GET['id'])){
                                    $id = mysqli_real_escape_string($con,$_GET['id']);
                                    $query_demo = "SELECT * FROM website_demo where id = '$id'";
                                    $query_demo_run = mysqli_query($con,$query_demo);
                                    if(mysqli_num_rows($query_demo_run)>0){
                                        $demo = mysqli_fetch_assoc($query_demo_run);

                                    }
                                    else{
                                        ?>
                                        <th>Customer not foun</th>
                                        <?php
                                    }
                                }
                                ...
                                <input type="hidden" name="id" value="<?=$id ?>">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control" name="website_type" id="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="description" class="form-control" id="editor" placeholder="Description" required>
                                                <?= $demo['description'] ?>
                                                </textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="mb-3">
                                                <label class="form-label" for="company">Link</label>
                                                <input type="text" name="link" class="form-control" value="<?= $demo['url'] ?>" id="company" placeholder="URL" required></input>
                                    ...
                                    <button class="btn btn-primary" name="master-btn-edit" type="submit">Add to Master</button>
                                <?php
                                } else {
                                ?>
                                    <th>No Categories Found</th>
                                    <br>
                                    <a class="btn btn-outline-primary mt-5" href="category.php">Add Category</a>
                                <?php
                                }
                                ?>
                            </form>
