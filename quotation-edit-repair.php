            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    if (isset($_GET['id'])) {
                        ...
                        $query = "SELECT * FROM quotation_repair WHERE id='$quotation_id'";
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <form action="quotation-edit-code.php" method="post" class="needs-validation" novalidate>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="device_condition" value="<?= $quotation['device_condition'] ?>" class="form-control"
                                                placeholder="Device Condition"></input>
                                            <!-- <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                        <div class="invalid-feedback">
                                ...
                                <button class="btn btn-primary" name="edit-repair"  type="submit">Save Changes</button>
