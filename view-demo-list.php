                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li><a href="quotation-repair-master.php" data-key="t-data-tables">Repair Master</a>
                                </li>
                            </ul>
                        </li>
                                    ...
                                    <div class="table-rep-plugin">
                                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                                            <table id="datatable-buttons"
                                                class="table table-bordered table-table-responsive nowrap w-100">
                                                <thead>
                                                    <tr>
                                                        <th>ID</th>
                                                        <th>Category</th>
                                                        <th>Website Type</th>
                                                        <th>Demo or Portfolio</th>
                                                        <th>Description</th>
                                                        <th>URL</th>
                                                        <!-- <th>Mobile 1</th>
                                                        <th>Mobile 2</th>
                                                 ...
                                                 <tbody>
                                                <?php
                                                $query = "SELECT * FROM website_demo WHERE markasdelete = 'No'";
                                                $query_category = "SELECT * FROM category where markasdelete = 'No'";
                                                $query_category_run = mysqli_query($con, $query_category);

                                                $query_run = mysqli_query($con, $query);

                                                if ((mysqli_num_rows($query_run) > 0) && (mysqli_num_rows($query_category_run) > 0)) {
                                                    foreach ($query_run as $demo) {
                                                        ?>
                                                        
                                                        <tr>
                                                            <th><?= $demo['id'] ?></th>
                                                            <th><?= $demo['category'] ?></th>
                                                            <th><?= $demo['website_type'] ?></th>
                                                            <th><?= $demo['demoOrPortfolio'] ?></th>
                                                            <th><?= $demo['description'] ?></th>
                                                            <th><a href="<?= $demo['url'] ?>" target="_blank"><?= $demo['url'] ?></a></th>
                                                            

                                                            
                                                            <th>
                                                                <div style="display: flex; gap:8px; align-items: center;">
                                                                <a href="web-demo-master-code.php?id=<?= $demo['id'] ?>" class="btn btn-outline-danger"><i class="fa-solid fa-trash"></i></a>
                                                                <a href="web-demo-master-edit.php?id=<?= $demo['id'] ?>" class="btn btn-outline-warning"><i class="fa-solid fa-pen-to-square"></i></a>
